          ...
          <FeatureCard>
            ...
            <div className="relative mb-6 border-t border-dashed sm:mb-0">
              ...
              <div className="aspect-76/59 p-1 px-6">
                <DualModeImage
                  darkSrc="https://cdn.mksaas.com/blocks/payments.png"
                  lightSrc="https://cdn.mksaas.com/blocks/payments-light.png"
            ...
            <CardContent>
              <div className="relative mb-6 sm:mb-0">
                ...
                <div className="aspect-76/59 border">
                  <DualModeImage
                    darkSrc="https://cdn.mksaas.com/blocks/origin-cal-dark.png"
                    lightSrc="https://cdn.mksaas.com/blocks/origin-cal.png"
