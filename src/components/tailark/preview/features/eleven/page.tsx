          ...
          <Card className="group overflow-hidden shadow-zinc-950/5 sm:col-span-3 sm:rounded-none sm:rounded-tl-xl">
            ...
            <div className="relative h-fit pl-6 md:pl-12">
              ...
              <div className="bg-background overflow-hidden rounded-tl-lg border-l border-t pl-2 pt-2 dark:bg-zinc-950">
                <Image
                  src="https://cdn.mksaas.com/blocks/mail2.png"
                ...
                />
                <Image
                  src="https://cdn.mksaas.com/blocks/mail2-light.png"
            ...
            <CardContent className="mt-auto h-fit">
              <div className="relative mb-6 sm:mb-0">
                ...
                <div className="aspect-76/59 overflow-hidden rounded-r-lg border">
                  <Image
                    src="https://cdn.mksaas.com/blocks/origin-cal-dark.png"
                    className="hidden dark:block"
                    alt="payments illustration dark"
                    width={1207}
                    height={929}
                  />
                  <Image
                    src="https://cdn.mksaas.com/blocks/origin-cal.png"
                    className="shadow dark:hidden"
                    alt="payments illustration light"
                    width={1207}
                    height={929}
